  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-foreground font-serif" data-testid="text-skills-heading">
            Tools & Technologies
          </h2>
          <motion.div 
            ...
            >
              <Card className="p-6 hover-elevate transition-all border-primary/20 group relative overflow-hidden h-full flex flex-col">
                ...
                <div className="relative z-10 flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-foreground mb-4 group-hover:text-primary transition-colors" data-testid={`text-category-${categoryIndex}`}>
                    {category.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.skills.map((skill, skillIndex) => (
                      ...
                      >
                        <Badge 
                          variant="secondary" 
                          className="text-xs md:text-sm bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 transition-colors cursor-default"
