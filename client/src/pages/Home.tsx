...
export default function Home() {
  ...
  const projects = [
    {
      id: "1",
      title: "Social Network Analytics for Layoffs Analysis Using Twitter",
      description: "Layoffs Analysis Using Twitter (Social Network Analytics):\n• Leveraged SNA and Twitter data analysis to assess the impact of layoffs, identifying key influencers and network relationships.\n• Collected, cleaned, and analyzed a dataset of 7,032 tweets from 4,557 users, demonstrating expertise in data analysis and metrics.\n• Utilized advanced analytical techniques to develop actionable recommendations for organizations, mitigating negative consequences of downsizing like decreased morale and productivity loss.",
      technologies: ["Social Network Analytics", "Twitter API", "Data Analysis", "Python", "Network Analysis", "Data Visualization"],
      liveUrl: "https://docs.google.com/presentation/d/1t271KXf5k5j7KD95ZzNoJaXpCCilJq3F/edit?usp=sharing&ouid=108140204768641018022&rtpof=true&sd=true",
    },
    {
      id: "2",
